    ...
    *,
    ...
    return RegressionPolicy(
        ...
        metric_policies=(
            ...
            RegressionMetricPolicy("mean_first_impression_score", "lower", 0.04, 0.08),
            RegressionMetricPolicy("mean_exploration_acceptance_rate", "lower", 0.04, 0.08),
            RegressionMetricPolicy("mean_abandonment_pressure", "higher", 0.04, 0.08),
            RegressionMetricPolicy("mean_cold_start_quality", "lower", 0.04, 0.08),
